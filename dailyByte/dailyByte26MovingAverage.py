# This question is asked by Microsoft. Design a class, MovingAverage, which contains 
# a method, next that is responsible for returning the moving average from a stream of integers.
...
class MovingAverage:
    def __init__(self, size):
        ...
        self.l = []
    def get_avg(self):
        return int(sum(self.l)/len(self.l))
    def next(self, val):
