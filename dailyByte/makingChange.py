# This question is asked by Facebook. Given an array that 
# represents different coin denominations and an amount of 
# change you need to make, return the fewest number of coins it 
# takes to make the given amount of change.
...
def makingChange(coins, amount):
    """
    We're given pennis, nickels, dimes, and quarters.W
    """
    pass